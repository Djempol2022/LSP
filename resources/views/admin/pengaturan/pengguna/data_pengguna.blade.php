        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    {{-- MODAL TAMBAH --}}
                    <div class="modal fade text-left" id="modalTambahPengguna" role="dialog"
                                        ...
                                        <div class="form-group">
                                            <select class="js-example-basic-single" name="institusi_id">
                                                ...
                                                @foreach ($institusi as $data_institusi)
                                                    <option value="{{ $data_institusi['id'] }}">
                                                        {{ $data_institusi['nama_institusi'] }}</option>
                                                @endforeach
                                            </select>
                                            <div class="input-group has-validation">
            ...
            {{-- MODAL EDIT --}}
            <div class="modal fade text-left" id="modalEditPengguna" role="dialog" aria-labelledby="myModalLabel33"
                aria-hidden="true">
