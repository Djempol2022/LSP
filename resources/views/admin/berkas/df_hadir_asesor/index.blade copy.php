      ...
      <form action="{{ route('admin.Berkas.DFHadirAsesor.Add') }}" method="POST">
        ...
        <div class="card p-5">
          ...
          <div style="text-align: center;">
            ...
            <h6 style="margin-bottom: 0; font-weight: bolder">TAHUN PELAJARAN <span
                id="thn_ajaran_df_hadir_asesor_1">2021/2022</span></h6>
          </div>
          <div style="margin-top: 20px; margin-left: 30px">
            <table style="width: 100%">
              <tr>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td style="text-align: center">1</td>
                  <td>
                    <span id="nama_df_hadir_asesor">Maria Victoria, M.Pd</span> <br />
                    <span id="nip_df_hadir_asesor">NIP</span>
                  </td>
                  <td id="jabatan_df_hadir_asesor">Jabatan</td>
                  <td>1</td>
                </tr>
        ...
        <div class="card p-5">
          ...
          <div style="text-align: center;">
            ...
            <h6 style="margin-bottom: 0; font-weight: bolder">UJI KOMPETENSI LSP-P1 SMKN 1 SINTANG</h6>
            <h6 style="margin-bottom: 0; font-weight: bolder">TAHUN PELAJARAN <span
                id="thn_ajaran_df_hadir_asesor_2">2021/2022</span></h6>
          </div>
          <div style="margin-top: 20px; margin-left: 30px">
            <table style="width: 100%">
              <tr>
                <td style="width: 12%">Hari/Tanggal</td>
                <td style="width: 3%">:</td>
                <td style="width: 85%"><span id="hari">Selasa</span> / <span id="tgl">1 Maret 2022</span>
                </td>
              </tr>
              <tr>
                <td>Waktu</td>
