...
<body>
  <div style="text-align: center">
    <p style="margin-top: 270px">No. {{ $user->relasi_user_detail->no_sertifikat ?? '-' }}</p>
    ...
    <h2 style="font-weight: bold; margin-top: 20px; margin-bottom: -15px">{{ $user->nama_lengkap }}</h2>
    <p>No. Reg. KTL.{{ $user->relasi_user_detail->no_reg ?? '-' }}</p>
    ...
    <h3 style="font-weight: bold; margin-bottom: -15px">{{ $user->relasi_jurusan->jurusan ?? 'Tidak ada data Jurusan' }}
    </h3>
    <p style="font-style: italic">{{ $jurusan }}</p>
    ...
    <h3 style="font-weight: bold; margin-bottom: -15px;">
      {{ $user->relasi_asesi_uji_kompetensi->relasi_jadwal_uji_kompetensi->relasi_muk->muk }}
    </h3>
    <p style="margin-bottom: -15px; font-style: italic">{{ $muk }}</p>
  ...
  <div style="width: 85%; margin: 0 auto;">
    <table style="margin: 0 auto; font-size: 15px; width: 100%" cellpadding='5' cellspacing='0'>
      <thead>
        <tr style="text-align: center">
          ...
          <th style="padding: 3px 5px">Kode Unit Kompetensi <br /><span style="font-weight: lighter">Code of Competency
              Unit</span></th>
      ...
      <tbody>
        @foreach ($user->relasi_skema_sertifikasi->relasi_unit_kompetensi as $item)
          <tr>
    ...
    <div style="margin-top: 120px">
      <div style="width: 85px; height: 100px; border: 2px solid #000000; margin-bottom: -15px">
        <img src="{{ $foto }}" alt="foto" style="width: 85px; height: 100px;">
      </div>
      <div style="text-align: left; width: 100%; margin-left: 40px">
        <div style="text-align: center; width: 40%">
          <p style="text-decoration: underline; font-weight: bolder; margin-bottom: -15px">{{ $user->nama_lengkap }}
          </p>
