      ...
      <div class="modal-body">
        ...
        <div class="card px-5">
          ...
          <div class="text-center d-flex flex-column">
            ...
            <h6>Nomor : <span class="no_sk"></span></h6>
                  ...
                  <tr>
                    ...
                    <td class="lh-sm align-text-top" style="width: 80%">
                      <ol class="ps-3">
                        ...
                        <li class="ps-3">Peraturan Pemerintah No. 31 tahun 2006 tentang Sistem Pelatihan Kerja
                          Nasional
                          (SISLATKERNAS)
                      ...
                      <div class="d-flex justify-content-end">
                        <div class="text-start" style="width: 35%">
                          <div class="d-flex justify-content-between">
                            ...
                            <span style="width: 50%" class="tempat_ditetapkan"></span>
                          </div>
                          <div class="d-flex justify-content-between">
                            <span style="width: 47%">Pada tanggal</span>
                            <span style="width: 3%">:</span>
                            <span style="width: 50%" class="tanggal"></span>
                          </div>
                          <div>
                            <span class="jabatan_bttd"></span>
                          </div>
                          <div><img src="" alt="ttd" width="180px" class="ttd"></div>
                          <div>
                            <span class="nama_bttd"></span>
                          </div>
                        </div>
                      </div>
                    </td>
              ...
              <tbody class="text-black">
                <tr>
                  ...
                  <td style="width: 90%" class="text-left">
                    <h6 class="fw-light mb-0 no_sk"></h6>
                  </td>
                </tr>
                <tr>
                  <td>
