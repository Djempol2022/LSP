<div class="modal fade" id="modalDetailZBAPecahRP" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5">Z Berita Acara Pecah Rapat Pleno</h1>
      ...
      <div class="modal-body">
        ...
        <div class="card p-5">
          ...
          <div style="margin-top: 20px">
            <p>Pada hari ini ............................................. tanggal
              ..................................................
              Bulan ................................................. tahun
              ............................................. bertempat di <span id="institusi_z_ba_pecah_rp"></span>,
              telah diadakan
              Rapat Pleno LSP SMK Negeri 1 Sintang untuk membahas hasil uji kompetensi <span
                id="skema_sertifikasi_z_ba_pecah_rp"></span>. <br />
              Adapun hasil dari Rapat Pleno tersebut tercantum sebagai berikut:
            </p>
            <div style="margin-top: 40px">
              <ol>
                <li>Pelaksanaan asesmen dilaksanakan pada tanggal <span id="tgl_tes_tertulis_z_ba_pecah_rp"></span>
                  untuk
                  tes tertulis dan tanggal
                  <span id="tgl_tes_praktek_z_ba_pecah_rp"></span> untuk tes praktek.
                </li>
                <li>
                  Jumlah asesi yang mengikuti uji kompetensi secara keseluruhan berjumlah <span
                    id="jumlah_asesi_z_ba_pecah_rp"></span> peserta.
                </li>
                <li>Uji Kompetensi dimulai dari pukul <span id="wkt_mulai_uk_z_ba_pecah_rp"></span> WIB sampai pukul
                  <span id="wkt_selesai_uk_z_ba_pecah_rp"></span> WIB di <span id="nama_tuk_z_ba_pecah_rp">TUK Lab. TKJ
                    SMKN 1 Jawai
                    Selatan</span>.
                </li>
          ...
          <div style="margin-top: 20px">
            <table style="width: 100%; margin-left: 28px">
              ...
              <tr>
                <td></td>
                <td id="jabatan_bttd_z_ba_pecah_rp"></td>
              </tr>
              <tr>
                <td></td>
              ...
              <tr>
                <td></td>
                <td style="font-weight: bold;" id="nama_bttd_z_ba_pecah_rp"></td>
              </tr>
              <tr>
                <td></td>
                <td>
                  MET.<span id="no_met_bttd_z_ba_pecah_rp"></span></td>
              </tr>
            </table>
          </div>
          ...
          <div style="margin-top: 20px">
            <div>
              <table style="width: 100%">
                ...
                <tr style="font-weight: bolder; color: black;">
                  <td>Tempat Rapat</td>
                  <td>:</td>
                  <td id="tempat_rapat_z_ba_pecah_rp"></td>
                </tr>
                <tr style="font-weight: bolder; color: black;">
                  <td>Topik</td>
                  <td>:</td>
                  <td id="topik_z_ba_pecah_rp"></td>
                </tr>
                <tr style="font-weight: bolder; color: black;">
                  <td>Ketua Rapat</td>
                  <td>:</td>
                  <td id="ketua_rapat_z_ba_pecah_rp"></td>
                </tr>
                <tr style="font-weight: bolder; color: black;">
                  <td>Notulis</td>
                  <td>:</td>
                  <td id="notulis_z_ba_pecah_rp"></td>
                </tr>
                <tr style="font-weight: bolder; color: black;">
            ...
            <div style="margin-top: 30px;">
              ...
              <p style="color: black;">Setelah pelaksanaan uji kompetensi pada tanggal <span
                  id="tgl_tes_tertulis_2_z_ba_pecah_rp"></span> dan <span id="tgl_tes_praktek_2_z_ba_pecah_rp"></span>,
        ...
        <div class="card px-5 pt-5">
          ...
          <div style="color: black;">
            ...
            <ol style="padding-left: 18px;" id="bahasan_diskusi_z_ba_pecah_rp">
            </ol>
          </div>
          ...
          <div style="margin-top: 20px">
            <table style="width: 100%;">
              ...
              <tr>
                <td>Notulis,</td>
                <td id="jabatan_bttd_2_z_ba_pecah_rp"></td>
              </tr>
              <tr>
                <td></td>
                <td style="height: 70px;"></td>
              ...
              <tr>
                ...
                <td style="font-weight: bold;" id="nama_bttd_2_z_ba_pecah_rp"></td>
              </tr>
              <tr>
                <td>
                  MET.<span id="no_met_notulis_2_z_ba_pecah_rp"></span></td>
                <td>
                  MET.<span id="no_met_bttd_2_z_ba_pecah_rp"></span></td>
              </tr>
            </table>
          </div>
