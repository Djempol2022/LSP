...
<body style="font-family: sans-serif">
  ...
  <div style="width: 90%; margin: 20px auto 0 auto; position: relative;">
    ...
    <div style="margin-top: 20px">
      <ol>
        <li>Pelaksanaan asesmen dilaksanakan pada tanggal {{ $z_ba_pecah_rp->tgl_tes_tertulis->isoFormat('D MMMM Y') }}
          untuk
        ...
        <li>Uji Kompetensi dimulai dari pukul {{ $z_ba_pecah_rp->wkt_mulai_uk->format('H:i') }} WIB sampai pukul
          {{ $z_ba_pecah_rp->wkt_selesai_uk->format('H:i') }} WIB di {{ $z_ba_pecah_rp->relasi_nama_tuk->nama_tuk }}.
        </li>
