        ...
        <div class="card">
            ...
            <div class="modal fade text-left w-100" id="modalDetailJadwalUjiKompetensi" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light-secondary tutupModalDatatable">
                ...
                <span class="badge bg-info rounded-pill">
                    <a class="text-white" href="#" data-bs-toggle="modal" data-bs-target="#tambahJadwalPenilaian">Tambah
...
<script>
    ...
    function tambahJadwalUjiKompetensi(id) {
        ...
        $("#isi-uji-kompetensi [name='id']").val(id)
        $("#isi-uji-kompetensi .jurusan").val(data_jurusan.jurusan)
    ...
    const table_jadwal_uji_kompetensi = $('#table-jadwal-uji-kompetensi').DataTable({
        ...
        "searching": false,
        ajax: {
            url: "/admin/data_jadwal_uji_kompetensi/"+jurusanId,
            type: "POST",
            // data:function(d){
            //     d.data_kabupaten = data_kabupaten;
            //     d.data_status_id = data_status_id;
        ...
        columnDefs: [{
            ...
            //     "render": function (data, type, row, meta) {
            //         let tampilan;
            //         tampilan = `<span id-jurusan = "${row.id}" onclick="tambahJadwalUjiKompetensi(${row.id})" class="badge bg-warning rounded-pill">
            //                         <a class="text-white" href="#">Edit</a>
            //                     </span>
            //                     <span class="badge bg-info rounded-pill">
            //                         <a href = "/lihat-jadwal-uji-kompetensi/${row.id}" class="text-white" href="#">Lihat Jadwal</a>
            //                     </span>`
            //         return tampilan;
            //     }
            // },
