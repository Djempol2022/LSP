                    ...
                    <div class="modal fade text-left" id="tambahKomponenUmpanBalik" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.TambahKomponenUmpanBalik') }}" id="form-tambahUmpanBalik"
                                    method="POST">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="input-group col-xs-12">
                                                ...
                                                <span class="input-group-append d-flex align-items-center"
                                                    style="padding: 8px;">
                                                    <button class="file-upload-browse btn btn-primary btn-tambah-komponen"
                                                        type="button">
                                                        +
                                                    </button>
                                                </span>
            ...
            <div class="modal fade text-left" id="modal-EditKomponenUmpanBalik" data-bs-backdrop="static"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form id="form-EditKomponenUmpanBalik" action="{{ route('admin.UbahKomponenUmpanBalik') }}"
                            method="POST">
