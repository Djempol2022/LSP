...
<div class="container mt-5 jalur-file">
    <p class="id_unit_kompetensi">{{ $jurusan_id }}</p>
    {{-- JALUR FOLDER --}}
            ...
            <form action="{{ route('admin.TambahUnitKompetensi') }}" id="formTambahUnitKompetensi" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" name="skema_sertifikasi_id"
...
@section('script')
<script>
    let data_sertifikasi_jurusan = @json($sertifikasi_jurusan);
    var id_unit_kompetensi = $('.id_unit_kompetensi').text();
    ...
    const table_data_unit_kompetensi = $('#table-data-unit-kompetensi').DataTable({
        ...
        "responsive": true,
        ajax: {
            url: "/admin/data-unit-kompetensi/" + id_unit_kompetensi,
            type: "POST",
            // data:function(d){
