            ...
            <div class="col isi">
                <form action="{{route('asesor.HasilKoreksiJawaban', ['jadwal_id'=>$jadwal_id, 'asesi_id'=>$asesi_id])}}" method="POST" id="form-hasilKoreksiJawaban">
                    <div class="row my-4">
                        ...
                        <div class="col-md-6">
                            <div class="col pb-4">
                                <label for="sesi" class="form-label fw-semibold">Keterangan</label>
                                <input class="form-check-input me-1" type="radio"
                                  name="status_kompeten" value="1"
                                  id="kompeten-1"
                                  @if(empty($data_hasil_koreksi->status_kompeten))
                                  @else
                                    {{ $data_hasil_koreksi->status_kompeten === 1 ? 'checked' : '' }}>
                                  @endif
                                ...
                                <input class="form-check-input me-1" type="radio"
                                  ...
                                  @if(empty($data_hasil_koreksi->status_kompeten))
                                  @else
                                    {{ $data_hasil_koreksi->status_kompeten === 0 ? 'checked' : '' }}>
                                  @endif
                                <label class="form-check-label text-success"
