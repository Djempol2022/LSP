                      ...
                      <hr> --}}
                                                    ...
                                                    <div class="col mb-3">
                                                        <div class="row mt-3">
                                                            ...
                                                            <input type="hidden" name="unit_kompetensi_isi[]"
                                                                value="{{ $isi->id }}" hidden>
                  ...
                  <input type="text" id="tanggal" name="tanggal" class="form-control input-text"
                    ...
                    @endisset
                                                            ...
                                                            <label for="signature-pad"
                                                                class="form-label fw-semibold">Tanda Tangan</label>

                                                            <div class="mb-2">
                                                                @isset($data_asesmen_mandiri->ttd_asesi)
                                                                    <img src="{{ $data_asesmen_mandiri->ttd_asesi }}"
                                                                        alt="ttd" width="180px">
                                                                @else
                                                                    ...
                                                                    <div class="col" id="signature-clear">
                                                                        <button type="button"
                                                                            class="btn-sm btn btn-danger mb-2"
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="col edit-profil-left">
                                                                <label for="namaAsesi"
                                                                    class="form-label fw-semibold">Nama Asesor</label>
                                                            ...
                                                            <div class="mb-2">
                                                                @isset($data_asesmen_mandiri->ttd_asesor)
                                                                    <img src="{{ $data_asesmen_mandiri->ttd_asesor }}"
                                                                        alt="ttd" width="180px">
                                                                @endisset
                                                            </div>
                                                        </div>
                                        ...
                                        @isset($data_asesmen_mandiri->ttd_asesi)
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary tombol-primary-small"
