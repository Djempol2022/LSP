<div class="modal fade" id="assesmentMandiri" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <form action="{{ route('asesi.Assesment.Store') }}" method="POST"
        id="form-PengajuanAsesmenMandiri">
        @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-black m-2">
                    ...
                    <div class="col">
                        <div class="assesment-mandiri-header">
                            ...
                            <p>{{ $sertifikasi->relasi_unit_kompetensi->relasi_skema_sertifikasi->judul_skema_sertifikasi ?? '' }}
                            </p>
                        </div>
                        <div class="assesment-mandiri-header">
                            <p class="assesment-mandiri-title">Nomor Skema Sertifikasi</p>
                            <p>{{ $sertifikasi->relasi_unit_kompetensi->relasi_skema_sertifikasi->nomor_skema_sertifikasi ?? '' }}
                            </p>
                        </div>
                        <div class="assesment-mandiri-header">
                            <p class="assesment-mandiri-title">Skema Sertifikasi</p>
                            <p>{{ $sertifikasi->relasi_unit_kompetensi->jenis_standar ?? '' }}
                            </p>
                        </div>
                    </div>
                    {{-- TITLE --}}
                    @foreach($unit_kompetensi as $data_unit_kompetensi)
                        <div class="col">
                            <div class="row col unit-kompetensi">
                                ...
                                <div class="col row fs-6">
                                    <div class="col-lg-auto unit-kode" style="width: auto !important">
                                        {{ $data_unit_kompetensi->kode_unit }}</div>
                        ...
                        <div class="col mb-5">
                            <ol class="list-group list-group-numbered">
                                @php
                                    $unit_kompetensi_sub =
                                    \App\Models\UnitKompetensiSub::with('relasi_unit_kompetensi.relasi_skema_sertifikasi')
                                    ->whereRelation('relasi_unit_kompetensi', 'unit_kompetensi_id',
                                    $data_unit_kompetensi->id)
                                    ->get();
                                @endphp
                                @foreach($unit_kompetensi_sub as $data_unit_kompetensi_sub)
                                    @php
                                        $unit_kompetensi_isi =
                                        \App\Models\UnitKompetensiIsi::with('relasi_unit_kompetensi_sub')
                                        ->whereRelation('relasi_unit_kompetensi_sub', 'unit_kompetensi_sub_id',
                                        $data_unit_kompetensi_sub->id)
                                        ->get();
                                    @endphp
                        ...
                        <hr> --}}
                        @php
                            $data_status_kompeten_asesi =
                            \App\Models\StatusUnitKompetensiAsesi::where('unit_kompetensi_isi_id', $isi->id)
                            ->where('user_asesi_id', Auth::user()->id)
                            ->first();
                        @endphp
                        <div class="col mb-3">
                            <div class="row mt-3">
                                <div class="col-auto kriteria-nomor">
                                    {{ $loop->parent->iteration }}.{{ $loop->iteration }}
                                </div>
                                <div class="col-auto kriteria-isi">
                                    {{ $isi->judul_unit_kompetensi_isi }}
                                </div>
                                <input type="hidden" name="unit_kompetensi_sub[]"
                                    value="{{ $isi->unit_kompetensi_sub_id }}" hidden>
                ...
                <div class="col mt-4">
                    <div class="mb-3 fw-semibold fs-6">
                        <label for="bukti_relevan-{{ $data_unit_kompetensi_sub->id }}" class="form-label">Bukti yang
                            relevan</label>
                        <textarea class="form-control border-tiernary"
                            id="bukti_relevan-{{ $data_unit_kompetensi_sub->id }}" rows="7"
                            placeholder="Masukkan Bukti Disini. . ."
            ...
            <div class="row col">
                <div class="col-lg-6">
                    ...
                    <div class="col edit-profil-left">
                        ...
                        <input type="text" id="namaAsesi" class="form-control input-text"
                            placeholder="Masukkan Nama Asesi. . ." value="{{ auth()->user()->nama_lengkap }}"
                            readonly>
                    </div>
                    <div class="col edit-profil-left">
                        <label for="tanggal" class="form-label fw-semibold">Tanggal</label>
                        <input type="text" id="tanggal" name="tanggal" class="form-control input-text" <blade
                    ...
                    <div class="mb-2">
                        @isset($data_asesmen_mandiri->ttd_asesi)
                            <img src="{{ $data_asesmen_mandiri->ttd_asesi }}" alt="ttd" width="180px" id="clear" >
                        @else
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col edit-profil-left">
                        ...
                        @isset($data_asesmen_mandiri->relasi_user_asesor->nama_lengkap)
                            <p>{{ $data_asesmen_mandiri->relasi_user_asesor->nama_lengkap }}
                            </p>
                        @else
                    ...
                    <div class="col edit-profil-left">
                        ...
                        @isset($data_asesmen_mandiri->tanggal_asesor)
                            <p>{{ Carbon\Carbon::parse($data_asesmen_mandiri->tanggal_asesor)->format('d F Y') }}
                            </p>
                        @else
...
@isset($data_asesmen_mandiri->ttd_asesi)
    <div class="modal-footer">
        <button type="button" class="btn btn-primary tombol-primary-small" data-bs-dismiss="modal">Kembali</button>
    </div>
@else
    <div class="modal-footer">
