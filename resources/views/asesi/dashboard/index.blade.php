    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-auto foto-profile">
                ...
                {{-- BUTTON EXPORT WORD --}}
                <div class="col mt-5 mx-0 p-0">
                    <button type="button" class="btn btn-primary tombol-primary-max" data-bs-toggle="modal"
                        data-bs-target="#exportWord">Export
                        Word</button>
                    <div class="modal fade" id="exportWord" tabindex="-1" aria-labelledby="exportWordLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exportWordLabel">Download Dokumen Word</h1>
